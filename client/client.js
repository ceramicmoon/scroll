/*
 *
 * NOTE: The client side of is currently in development,
...
"|",
	...
	"|",
	"|",
	"| This is the homepage of **MagicScroll**, a quick minimalist chatroom/text-conferencing system for mathematicians (or anyone in a maths-intensive profession) designed to resolve the existing inconvenience in temporary, professional, private communications online.",
	"|",
	"## To create a chatroom",
	"| Simply append the name of your room (e.g. your-channel) after a question mark in the url in this way: [<this-url>/?your-channel]()",
	"|",
	"|",
	"## Privacy",
	"| There is no list of all created rooms. Nor do we kept chat history inside any room. Thus, you can enjoy perfect privacy for setting up your room and for all your communications (the only issues being to set up a proper room name to prevent others from breaking in (but room passcode feature coming soon), and to remember to save important content yourself, which can be done in many ways, e.g. by saving the chatroom page as a local webpage.",
	"|",
	"|",
	"## Inputting",
	"| Our chatrooms support chatting with full regular Markdown syntax and LaTeX (powered by KaTeX) for mathematical formulae. Simply surround inline-sytle formulae between single dollar signs $\\Beta(a,b) = \\frac{\\Gamma(a)\\Gamma(b)}{\\Gamma(a+b)}$, and display-style formulae between double dollar signs $$\\delta(x - x') = \\frac{1}{2\\pi}\\int_{-\\infty}^{\\infty}e^{\\mathrm{i}(x-x')}\\mathrm{d}t$$",
	"|",
	"| For displaying code blocks, wrap the code as follows: \\`<your code>\\` (`<your code>`)or \\`\\`\\`<also your code>\\`\\`\\` (```<also your code>```). Multi-line messages can be entered with Shift+Enter. Multi-line code blocks can be displayed with the initial and final \\`\\`\\` each on its own line.",
	"|",
	"|",
	"## Whiteboard (beta)",
	...
	"|",
	"## Public rooms",
	"| Here are some chatrooms set up as public. Click on them to have a try:",
	"|",
	"| ?math-general ?algebra-geometry ?physics ?cs",
	"| ?lounge ?gaming ?français ?中文",
	"|",
	"| Get a random secret room link (re-generated upon refreshing): ?" + Math.random().toString(36).substr(2, 8),
	"|",
	"|",
	"|",
	"| Made by CeramicMoon with [hack.chat](https://github.com/AndrewBelt/hack.chat), also powered by [whitebophir](https://github.com/lovasoa/whitebophir) and love :P",
	""
].join("\n");
...
var COMMANDS = {
	...
	onlineSet: function (args) {
		...
		pushMessage({ nick: '*', text: "Users online: " + nicks.join(", ") + ". This room's shared whiteboard: https://whiteboard-online.org/boards/magicscroll-" + window.location.search.slice(1,) + " ."})
	},
